...
The grid-like nature will facilitate spatial interpolation not only for the the purposes of vector control, but also for disease risk factors (hypothetical examples below):  
