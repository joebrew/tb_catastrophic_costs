...
We will limit the number of health facilities to 27 (above the recommended 25).  Given that previous studies have suggest a gamma of 30%-50%, we assume a gamma of 30% (blue line in the above chart), suggesting a necessary minimum cluster size of 26 per participating health center.  This is feasible, as 100% of provinces saw an average of more than 26 cases per district in 2013 (the last year for which data are available), and many see an annual number of cases far in excess of our minimum:  
...
ggplot(data = tb,
  ...
  theme_tufte() +
  ggtitle('Distribution of cases by district, 2013') +
...
2. The secondary randomization has a simple exclusion criteria - for a facility to be eligible for assignment, it must have a previous annual notification rate of at least 26 cases per year. 
...
for (kk in seq(0.1, 0.6, length = 11)){
  k <- kk
  m <- 26
  clusters <- 27
  response_rate <- 0.9
