...
Given that our target precision is 0.2, and that we wish to limit the number of health facilities to 27 (slightly above the recommended 25), we arrive at a facility-specific sample size of 26.    
